...
#define BOOTLOADER_STATUS_BT_MFB_ON 0x02
#define BOOTLOADER_STATUS_BT_MFB_OFF 0x04
...
#define BT_DATA_SEL_MFB_MODE TRISEbits.TRISE4
#define BT_DATA_SEL_MFB LATEbits.LATE4
